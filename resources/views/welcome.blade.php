                        ...
                        <div class="user-body">
                                ...
                                <div class="user-info">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <input type="text" id="location" name="location" class="form-control" value="{{ auth()->user()->location ?? '' }}">
                                    </div>
                                </div>
                        ...
                        <div class="user-header">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label for="newsletter" class="form-check-label">Receive newsletter updates</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" id="account_updates" name="account_updates" class="form-check-input" checked>
                                        <label for="account_updates" class="form-check-label">Receive account updates</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" id="marketing" name="marketing" class="form-check-input">
                                        <label for="marketing" class="form-check-label">Receive marketing emails</label>
                                    </div>
                                </div>
